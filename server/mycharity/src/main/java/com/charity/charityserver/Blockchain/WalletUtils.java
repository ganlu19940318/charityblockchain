package com.charity.charityserver.Blockchain;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.arxanfintech.common.rest.Client;
import com.arxanfintech.sdk.wallet.Wallet;
import com.charity.charityserver.Blockchain.Pojo.CreatePOEResponse;
import com.charity.charityserver.Blockchain.Pojo.Payload;
import com.charity.charityserver.Blockchain.Pojo.QueryPOEResponse;
import com.charity.charityserver.Blockchain.Pojo.RegisterResponse;
...
public class WalletUtils {
    ...
    // access -- username
    // secret -- password
    public static String[] register(String access, String secret) throws Exception{
        Wallet wallet = init();
    ...
    // id ---- walletid
    // privatekeyBase64 ---- pk64
    // name and info ---- random
    public static String createPOE(String id, String name, String privatekeyBase64, String info){
        Wallet wallet = init();
    ...
    public static String queryPOE(String id){
        Wallet wallet = init();
        String strheader = "{\"Bc-Invoke-Mode\":\"sync\"}";
        JSONObject jsonheader = JSON.parseObject(strheader);
        String response = null;
    ...
    public static void updataPOE(String POEid, String owner, String privateKeyBase64, String info){
        Wallet wallet = init();
        String strheader = "{\"Bc-Invoke-Mode\":\"sync\"}";
        JSONObject jsonheader = JSON.parseObject(strheader);
        BASE64Encoder encoder = new BASE64Encoder();
